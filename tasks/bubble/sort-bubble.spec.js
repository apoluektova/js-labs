...
describe('sortByBubble', () => {
  it('Should be a function', () => {
    assert.equal(typeof sortByBubble, 'function', 'Is not a function');
  });
  ...
  describe('Should return correct result', () => {
    it('Example 1', () => {
      ...
      assert.deepEqual(sortByBubble(input), output, 'Arrays are one instance');
    });
    ...
    it('Example 3', () => {
      ...
      assert.deepEqual(sortByBubble(input), output, 'Arrays are not equals');
    });
